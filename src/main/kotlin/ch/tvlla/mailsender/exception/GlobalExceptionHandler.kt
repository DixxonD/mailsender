...
class GlobalExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleSMTPSendFailedException(ex: MailSendException): ResponseEntity<String>{
        logger.warn(ex.message)
        return ResponseEntity<String>("Die Nachricht konnte nicht versendet werden.", HttpStatus.BAD_REQUEST)
    }
